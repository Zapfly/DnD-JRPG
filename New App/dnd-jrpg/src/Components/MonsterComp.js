...
const MonsterComp = (props) => {
    ...
    return (
        <div className="monster container col-sm-6 col-md-4 text-center justify-content-center m-0 p-2" onClick={() => appContext.setSelectedMonster(props.monsterInfo)}>
            <div className={`container p-2 border border-secondary ` + (JSON.stringify(props.monsterInfo) === JSON.stringify(appContext.selectedMonster) ? "selected" : null)}>
