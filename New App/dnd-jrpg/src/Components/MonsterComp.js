...
const MonsterComp = (props) => {
    ...
    const handleClick = () => {
        appContext.arena.setSelectedMonster(props.monsterInfo);
    ...
    return (
        <div className="monster container col-sm-6 col-md-4 text-center justify-content-center m-0 p-2" onClick={handleClick}>
            <div className={`container p-2 border border-secondary ` + (props.monsterInfo === appContext.arena.selectedMonster ? "selected" : null)}>
